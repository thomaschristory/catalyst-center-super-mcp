...
@pytest.mark.asyncio
async def test_login_captures_token(httpx2_mock: respx.Router) -> None:
    httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
...
@pytest.mark.asyncio
async def test_login_ignores_message_field(httpx2_mock: respx.Router) -> None:
    httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
...
@pytest.mark.asyncio
async def test_login_sends_basic_auth_header(httpx2_mock: respx.Router) -> None:
    """The token endpoint expects HTTP Basic — verify the Authorization header on the request."""
    route = httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
...
@pytest.mark.asyncio
async def test_login_401_raises_autherror(httpx2_mock: respx.Router) -> None:
    httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
...
@pytest.mark.asyncio
async def test_login_500_raises_autherror(httpx2_mock: respx.Router) -> None:
    httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
...
@pytest.mark.asyncio
async def test_login_missing_token_field_raises(httpx2_mock: respx.Router) -> None:
    httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
...
@pytest.mark.asyncio
async def test_relogin_replaces_token(httpx2_mock: respx.Router) -> None:
    httpx2_mock.post("https://cc.example.com:443/dna/system/api/v1/auth/token").mock(
        side_effect=[
